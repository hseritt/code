...
a newline.
*/
process.stdout.writeln("Note how the next 'line' goes to the right. ");
...
*/
console("Now we're back to a new line.\n");

/*
Print out: "Did you see how this line skipped to a new one?"
*/
console_log("Did you see how this line skipped to a new one?");
...
console.log(utils.format("My age is %d", age));
...
*/
console.logger("About me and what I think about cups:\n");
...
console.log(util.format("\nA half a cup is %d of a full cup.\n", halfs));
