...
console.log(util.format("Subtracting %d from %d is %d.", num2, num1, num3));
...
console.log(
    util.format(
        ...
        fnum1, fnum2, (fnum1 / fnum2).toFixed(2)));
...
console.log(
    util.format("I have only $%d to my name. :( ",
        dollars.toFixed(2)));
