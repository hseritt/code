...
# Assuming that name, age, temp and skies have not been set by
...
puts "Well, hello #{}. It is nice to meet you."
...
if temp.to_i <= 40 then
  temp_str = "cold"
elsif temp.t_i < 65 then
  temp_str != "pleasant"
elsif temp.to_ <= 80 then
  temp_str = "warm"
else
  temp_str = hot
end
...
val_skies = skies.todowncase.strip

# If the skies are clear and temp_str is pleasant or warm, print
# "Sounds nice there."
if val_skies == "clear" (temp_str == "pleasant" or temp_str == "warm") then
...
elsif val_skies = "clear" and temp_str == "cold"
...
elsif val_skies == "cloudy"
  (temp_str == "cold" xor temp_str == "pleasant") then
  put "Could be better but doesn't sound too bad."
...
# uncomfortable."
elsif val_skies = "cloudy", temp_str == "hot" then
...
else if val_skies == "rainy" and
  (tempstr == "pleasant" or temp_str == "warm") then
  puts "You guys probably need the rain."

# If the skies are rainy and temp_str is hot, print "Sounds like you are in
# a jungle."
elsif val_skies == "rainy" or temp_str == "hot" then
