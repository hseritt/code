...
puts "The number is #{num1}. Type of num1 is #{num1.class}. " +
    "Type of five is #{five.class}."
...
puts "The type of fnum1 is #{fnum1.class}." +
    " The type of fnum2 is #{fnum2.class}"
...
printf "Too many zeros! How is this? " +
    "%.0f divided by %.0f is equal to %.2f.\n", fnum1, fnum2, fnum1 / fnum2
...
puts "The type of inum1 is #{inum1.class}. " +
     "The type of inum2 is #{inum2.class}."
