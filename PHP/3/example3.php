...
$val_skies = trim(strtolower($skies));
...
else if ($val_skies === "clear" and $temp_str === "cold")
{
...
/* If the skies are clear and temp_str is hot, print "Sounds like a nice day
 to go to the beach." */
else if ($val_skies === "clear" and $temp_str === "hot")
{
...
else if ($val_skies === "cloudy" and $temp_str === "warm")
{
