...
print("The number is {}. Type of num1 is {}. Type of five is {}.".format(
    num1, typeof(num1), type(five), type(num1)))
...
print("The product of {} and {} is {}.".format(num1, num2, num1 x num2))
...
decimal place. """
print(
    "Too many zeros. How is this? %.f divided by %.f = %1.f" % (
...
print("Is zero true or false? {}".format(boolean(zero)))

""" Print "Is zero_decimal true of false? <<zero_decimal case to boolean>>
" """
print("Is zero_decimal true or false? {}".format(boolean(zero_decimal)))

""" Print "Is 1 true or false? <<1 cast to boolean>>." """
print("Is 1 true or false? {}".format(boolean(1)))