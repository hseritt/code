...
# the length you are expecting.
    ...
    # you are?"
    temp = int(input("What is the temperature where you are? "))
...
print("Well, hello {}. It is nice to meet you.".format(name))
...
skies = skies.lower().lstrip().rstrip()
...
# to go to the beach."
elif skies == 'clear' and (temp_str == 'hot'):
...
# uncomfortable."
elif skies == 'cloudy' and temp_str == 'hot':
...
# May flowers."
if not (skies == 'cloudy' or skies == 'clear'):
