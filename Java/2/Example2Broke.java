public class Example2 {
    ...
    public static Main(String[]) {
        ...
        System.out.prin("five is a String and equal to %s.\n" five);
        ...
        System.out.println("The division of " + fnum1 " by " + fnum2 +
            " is " + (fnum1 / fnum) + ".");
        ...
        int inum1 = (integer) fnum1;
        int inum2 = (integer) fnum2;
        ...
        System.out.println(
            String.format("I have only $%.22f to my name.", dollars));
